...
class PluginDeveloperController extends PluginController {
	...
	public function __construct() {
		...
		if (version_compare(FROG_VERSION, '0.9.5', '<')) {
			...
			View('../../../plugins/plugin_developer/views/sidebar'));            
		} else {
	...
	function addplugin_db() {
		...
		$frog_required_1 = mysql_escape_string($_POST['frog_required_1']);
		$frog_required_2 = mysql_escape_string($_POST['frog_required_2']);
		$frog_required_3 = mysql_escape_string($_POST['frog_required_3']);
...
(id, plugin_name, plugin_author, plugin_email, plugin_website, plugin_overview, plugin_version_1, plugin_version_2, plugin_version_3, frog_required_1, frog_required_2, frog_required_3, plugin_license, plugin_date_created, plugin_date_updated, plugin_created_by, plugin_updated_by, plugin_id, plugin_condition, plugin_file_url, plugin_downloads, plugin_status)
VALUES
('', '".$plugin_name."', '".$plugin_author."', '".$plugin_email."', '".$plugin_website."', '".$plugin_overview."', '".$plugin_version_1."', '".$plugin_version_2."', '".$plugin_version_3."', '".$frog_required_1."', '".$frog_required_2."', '".$frog_required_3."', '".$plugin_license."', '".$plugin_date_created."', '".$plugin_date_updated."', '".$plugin_created_by."', '".$plugin_updated_by."', '".$plugin_id."', '".$plugin_condition."', '".$plugin_file_url."', '0', '".$plugin_status."')";
	...
	function editplugin_db() {
		...
		$sql = "UPDATE ".TABLE_PREFIX."plugin_developer_plugins SET
			...
			`frog_required_1`='".$frog_required_1."',
			`frog_required_2`='".$frog_required_2."',
			`frog_required_3`='".$frog_required_3."',
...
('', '".$license_type."')";
	...
	function add_condition() {
		...
		$sqlo = $__FROG_CONN__->prepare($sqlo);
        $sqlo->execute(); 
